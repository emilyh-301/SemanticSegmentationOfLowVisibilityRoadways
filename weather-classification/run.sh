...
for i in "${arr[@]}"
do
	ssh "$i" "cd ~/Documents/GitHub/SemanticSegmentationOfLowVisibilityRoadways/weather-classification/; python3 research.py ~/Documents/weather_dataset/resized/ save${count}/ > /dev/null 2>&1 & exit"
done